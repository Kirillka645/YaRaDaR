...
android {
    namespace = "com.radar.coefficients"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.radar.coefficients"
        minSdk = 26
        targetSdk = 35
        versionCode = 7
        versionName = "1.0.7"
        ...
        buildConfigField("String", "DEMAND_API_BASE_URL", "\"${prop("DEMAND_API_BASE_URL", "http://10.0.2.2:8080")}\"")
