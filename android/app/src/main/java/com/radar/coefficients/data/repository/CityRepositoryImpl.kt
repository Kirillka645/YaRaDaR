...
class CityRepositoryImpl @Inject constructor(
    ...
    private fun buildSeedCatalog(): List<City> {
        ...
        return listOf(
            ...
            city("ru-kostroma", "Кострома", "Костромская область", ru, 57.7679, 40.9269),
            city("ru-yar", "Ярославль", "Ярославская область", ru, 57.6261, 39.8845),
            city("ru-ivanovo", "Иваново", "Ивановская область", ru, 56.9972, 40.9714),
